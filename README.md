...
The TTML content may be segmented in the following ways:
 - A single TTML document is created for the entire streaming session. The document is marked as redundant in all but the first sample or segment ([technical details](#sample_has_redundancy)).
...
Examples can be found [here](https://github.com/rbouqueau/TTML_in_MP4_DASH_statement/wiki/ebuttd_in_isobmff_samples).
